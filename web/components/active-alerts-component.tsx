...
const mockAlerts: Alert[] = [
  ...
  },
  {
    ...
    description: "Tourist lost in crowded market area, unable to locate accommodation",
    responders: ["Tourist-Help-Sikkim-01"],
  ...
  },
  {
    ...
    location: {
      address: "Kohima War Cemetery, Nagaland",
      coordinates: { lat: 25.6669, lng: 94.1062 },
    },
    tourist: {
      name: "Lisa Chen",
    ...
    description: "Tourist collapsed due to heat exhaustion at historical site",
    responders: ["Medical-Team-Nagaland-01", "Emergency-Response-02"],
  ...
  },
  {
    ...
    location: {
      address: "Dimapur Railway Station, Nagaland",
      coordinates: { lat: 25.9117, lng: 93.7217 },
    },
    tourist: {
      name: "Hans Mueller",
      nationality: "Germany",
    ...
    description: "Passport and wallet stolen at railway station, urgent assistance needed",
    responders: ["Police-Unit-Dimapur-01", "Consulate-Support-01"],
    estimatedResponse: "7 minutes",
  },
  {
    id: "ALT009",
    digitalId: "IND864209",
    ...
    description: "Tourist reported verbal harassment by local vendors",
    responders: ["Police-Unit-Mizoram-02"],
    estimatedResponse: "5 minutes",
  },
  {
    id: "ALT010",
    ...
    location: {
      ...
      coordinates: { lat: 27.585, lng: 91.85 },
    },
    tourist: {
      name: "David Kim",
    ...
    description: "Tourist activated panic button during monastery visit, feeling threatened",
    responders: ["Security-Team-Tawang-02", "Monastery-Security-01"],
  ...
  },
  {
    ...
    severity: "medium",
    status: "active",
    timestamp: "2024-12-09T06:45:00Z",
    location: {
      address: "Nohkalikai Falls, Cherrapunji, Meghalaya",
      coordinates: { lat: 25.3, lng: 91.5833 },
    },
    tourist: {
    ...
    description: "Tourist lost near waterfall area, last seen 2 hours ago",
    responders: ["Tourist-Help-Meghalaya-01", "Local-Guide-02"],
  ...
  },
  {
    ...
    severity: "high",
    status: "responding",
    timestamp: "2024-12-09T05:20:00Z",
    location: {
      address: "Bomdila Monastery, Arunachal Pradesh",
      coordinates: { lat: 28.2167, lng: 94.6667 },
    },
    tourist: {
      name: "Rajesh Kumar",
      nationality: "India",
    ...
    description: "Altitude sickness reported at high altitude monastery",
    responders: ["Medical-Team-Arunachal-01", "Monastery-Medical-01"],
    estimatedResponse: "8 minutes",
  },
  {
    id: "ALT013",
    ...
    severity: "medium",
    status: "active",
    timestamp: "2024-12-09T04:15:00Z",
    location: {
    ...
    description: "Camera equipment stolen near lake area",
    responders: ["Police-Unit-Sikkim-01", "Tourist-Help-03"],
    estimatedResponse: "12 minutes",
  },
  {
    id: "ALT014",
    ...
    severity: "high",
    status: "responding",
    timestamp: "2024-12-09T03:30:00Z",
    location: {
      address: "Kaziranga National Park Core Area, Assam",
      coordinates: { lat: 26.65, lng: 93.36 },
    },
    tourist: {
      name: "James Wilson",
      nationality: "Canada",
    ...
    description: "Tourist entered restricted wildlife core area without permit",
    responders: ["Forest-Guard-01", "Wildlife-Protection-01"],
    estimatedResponse: "6 minutes",
  },
  {
    id: "ALT015",
    ...
    severity: "medium",
    status: "active",
    timestamp: "2024-12-09T02:45:00Z",
    location: {
      address: "Kangla Fort, Imphal, Manipur",
      coordinates: { lat: 24.817, lng: 93.935 },
    },
    tourist: {
      name: "Aisha Patel",
    ...
    description: "Tourist reported harassment by local vendors at historical site",
    responders: ["Police-Unit-Manipur-04", "Tourist-Help-04"],
    estimatedResponse: "10 minutes",
  }
]
